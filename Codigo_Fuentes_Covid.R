library(readr)
library(dplyr)
Analisis_aguas_residuales_covid <- read_delim("C:/Users/Usuario/Desktop/Universidad/Asignaturas/3º Curso/5º Semestre/Fuentes de datos biomédicas y web semántica/Seminario/Bases_de_datos/analisis-aguas-residuales-covid.csv", 
